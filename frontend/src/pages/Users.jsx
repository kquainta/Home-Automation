  ...
  if (!isAdmin) {
    return (
      <div className="max-w-7xl mx-auto px-6 py-10">
        <section className="glass p-8 rounded-3xl border-l-4 border-red-500/60">
          <h2 className="text-lg font-bold mb-4 text-slate-100 flex items-center gap-2">
            <UsersIcon className="w-5 h-5 text-red-400" aria-hidden />
            Access Denied
          </h2>
          <p className="text-slate-400">You must be an administrator to access user management.</p>
        </section>
      </div>
    );
  }
